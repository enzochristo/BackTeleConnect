...
def validate_manager_auth_token(request: Request, response: Response):
    ...
    try:
        ...
        print(os.getenv("MANAGER_JWT_SECRET"))
        ...
        raise HTTPException(status_code=401, detail="Invalid JWT token2")
